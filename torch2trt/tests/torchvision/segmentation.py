...
@LastEditTime: 2020-06-17 21:15:19
'''
import torch
import torchvision
...
def deeplabv3_resnet50():
    bb = torchvision.models.segmentation.deeplabv3_resnet50(pretrained=False, pretrained_backbone=False)
...
def deeplabv3_resnet101():
    bb = torchvision.models.segmentation.deeplabv3_resnet101(pretrained=False, pretrained_backbone=False)
    model = ModelWrapper(bb)
    return model
